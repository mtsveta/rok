...
folder_results = 'results-P-100Pascal/demo-dolomitization-heterogeneous-localized-wihtout-smart-initialization-odml'
...
def run_transport(use_smart_equilibrium):
    ...
    #field.setPressures(flow.p.dat.data) # Tfor k in range(self.num_dofs):ODO: should not pressure be sync w.r.t. to the pressure found in the Darcy?
