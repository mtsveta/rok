...
tag_conv = "-" + activity_model + \
      ...
      "-nsteps-" + str(nsteps) + \
      "-conv"
folder_results = 'results-12.05.20/demo-chemicaltransport-heterogeneous-odml-opengeosys-example-1'
...
def run_transport(use_smart_equilibrium):
    ...
    state_ic.scalePhaseVolume("Aqueous", 0.3, "m3")
    state_ic.scalePhaseVolume("Quartz", 0.686, "m3") # 0.686 = 0.7 * 0.98
    state_ic.scalePhaseVolume("Calcite", 0.014, "m3") # 0.014 = 0.7 * 0.02
    #
    #
    # quartz(85 %), albite(4 %), K‐feldspar(6 %), illite (2 %), smectite(2 %) and kaolinite(1 %).A
    # water
    ...
    # halite
    # salinity
    # with the reservoir mineral package, and the result-
    # ing
    # water
